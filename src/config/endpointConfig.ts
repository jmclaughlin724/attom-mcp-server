...
export const endpoints: Record<string, EndpointConfig> = {
  ...
  propertyBasicProfile: {
    ...
    requiredParams: [],
    optionalParams: ['address1', 'address2'],
  ...
  saleSnapshot: {
    ...
    optionalParams: ['startsalesearchdate', 'endsalesearchdate'],
    fallbackStrategy: FallbackStrategy.NONE,
    rateLimit: DEFAULT_RATE_LIMIT,
    cache: PROPERTY_CACHE,
  },
  ...
  schoolSearch: {
    ...
    requiredParams: [],
    optionalParams: ['geoIdV4', 'address', 'latitude', 'longitude', 'radius', 'page', 'pageSize'],
    fallbackStrategy: FallbackStrategy.ADDRESS_TO_GEOID,
    rateLimit: DEFAULT_RATE_LIMIT,
    cache: PROPERTY_CACHE,
  },
  ...
  poiSearch: {
    ...
    requiredParams: [],
    optionalParams: ['address', 'point', 'radius', 'categoryName', 'zipcode'],
    fallbackStrategy: FallbackStrategy.NONE,
    rateLimit: DEFAULT_RATE_LIMIT,
    cache: VOLATILE_CACHE,
  },
