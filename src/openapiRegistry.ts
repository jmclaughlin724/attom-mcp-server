...
openApiRegistry.registerPath({
  ...
  description: 'Returns comparable property sales based on address with configurable search parameters.',
  request: {
    params: z.object({
      street: z.string().describe('Street address'),
      city: z.string().describe('City name'),
      county: z.string().describe('County name or "-" if unknown'),
...
openApiRegistry.registerPath({
  ...
  request: {
    ...
    query: z.object({
      ...
      minComps: z.number().optional(),
      maxComps: z.number().optional(),
      miles: z.number().optional(),
      sameCity: z.boolean().optional(),
      useSameTargetCode: z.boolean().optional(),
      bedroomsRange: z.number().optional(),
      bathroomRange: z.number().optional(),
      sqFeetRange: z.number().optional(),
      lotSizeRange: z.number().optional(),
      saleDateRange: z.number().optional(),
      yearBuiltRange: z.number().optional(),
      ownerOccupied: z.string().optional(),
      distressed: z.string().optional(),
    }).describe('SalesComparablesAddressQuery')
  },
  responses: {
    '200': {
...
openApiRegistry.registerPath({
  method: 'get',
  path: '/property/v2/salescomparables/propid/{propId}',
  summary: 'Comparable sales for a property by propId (fallback from address => attomId => propId). Additional query params accepted.',
  request: {
    params: z.object({ propId: z.string() }),
    query: z.object({
      searchType: z.string().optional(),
      minComps: z.number().optional(),
      maxComps: z.number().optional(),
      ...
      ownerOccupied: z.string().optional(),
      distressed: z.string().optional(),
    }).describe('SalesComparablesPropidQuery')
  },
  responses: {
    '200': {
      description: 'Comparable sales data',
