...
(function (EndpointCategory) {
    EndpointCategory["PROPERTY"] = "property";
    EndpointCategory["ASSESSMENT"] = "assessment";
    EndpointCategory["SALE"] = "sale";
    EndpointCategory["MORTGAGE"] = "mortgage";
    EndpointCategory["PERMIT"] = "permit";
    EndpointCategory["RENTAL"] = "rental";
    EndpointCategory["SCHOOL"] = "school";
    EndpointCategory["COMMUNITY"] = "community";
    EndpointCategory["POI"] = "poi";
    EndpointCategory["ALLEVENTS"] = "allevents";
    EndpointCategory["AVM"] = "avm";
    EndpointCategory["TRANSPORTATION"] = "transportation";
...
(function (FallbackStrategy) {
    FallbackStrategy["ADDRESS_TO_ATTOMID"] = "address-to-attomid";
    FallbackStrategy["ADDRESS_TO_GEOID"] = "address-to-geoid";
    FallbackStrategy["ATTOMID_TO_ID"] = "attomid-to-id";
    FallbackStrategy["TRY_ALLEVENTS_FIRST"] = "try-allevents-first";
    FallbackStrategy["NONE"] = "none";
})(FallbackStrategy || (FallbackStrategy = {}));
/**
 * Data fields available in allevents/detail response
 */
export var AllEventsDataField;
(function (AllEventsDataField) {
    AllEventsDataField["PROPERTY"] = "property";
    AllEventsDataField["AVM"] = "avm";
    AllEventsDataField["ASSESSMENT"] = "assessment";
    AllEventsDataField["SALE"] = "sale";
    AllEventsDataField["BUILDING"] = "building";
    AllEventsDataField["DEED"] = "deed";
    AllEventsDataField["MORTGAGE"] = "mortgage";
    AllEventsDataField["TAX"] = "tax";
})(AllEventsDataField || (AllEventsDataField = {}));
/**
 ...
 */
export function getEndpointConfig(key) {
 ...
 */
export function hasRequiredParams(endpointKey, params) {
 ...
 */
export function getFallbackStrategy(endpointKey) {
    const config = getEndpointConfig(endpointKey);
 ...
 */
export function getAllEventsFields(endpointKey) {
    const config = getEndpointConfig(endpointKey);
 ...
 */
export function canUseAllEventsData(endpointKey) {
    const config = getEndpointConfig(endpointKey);
