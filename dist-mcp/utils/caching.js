...
export function getRequestCache(cacheKey) {
 ...
 */
export function cacheData(key, data, endpoint) {
 ...
 */
export async function preloadAddressMetadata(address1, address2, cacheKey) {
